"""
Django settings for quick_cash_41597 project.
...
ROOT_URLCONF = 'quick_cash_41597.urls'
...
WSGI_APPLICATION = 'quick_cash_41597.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quick_cash_41597 API",
    "DESCRIPTION": "API documentation for quick_cash_41597 App",
    "VERSION": "v1",
}
